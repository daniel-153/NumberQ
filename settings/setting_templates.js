...
export const ratex_add_sub_form = {
    ...
    radio_buttons: [
        ...
        ['as_1','\\frac{1}{ax}\\pm\\frac{1}{bx}','radio-math'],
        ['as_2','\\frac{1}{x+a}\\pm\\frac{1}{x+b}','radio-math'],
        ['as_3','\\frac{a}{x+b}\\pm\\frac{c}{x+d}','radio-math'],
        ['as_4','\\frac{a}{bx+c}\\pm\\frac{d}{ex}','radio-math'],
        ['as_5','\\frac{a}{bx+c}\\pm\\frac{d}{ex+f}','radio-math'],
        ['as_6','\\frac{ax+b}{cx+d}\\pm\\frac{ex+f}{gx+h}','radio-math'],
        ['as_7','\\frac{ax+b}{cx+d}\\pm\\frac{e}{f}','radio-math'],
        ['as_8','\\frac{a}{x^2+bx+c}\\pm\\frac{d}{x+e}','radio-math'],
        ['as_9','\\frac{x+a}{bx^2+cx}\\pm\\frac{d}{bx+c}','radio-math'],
        ['as_10','\\frac{a}{bx^2+cx}\\pm\\frac{d}{ex}','radio-math'],
        ['as_11','\\frac{x+a}{x^2+bx+c}\\pm\\frac{x+d}{x+e}','radio-math'],
        ['as_12','\\frac{x+a}{x^2+bx+c}\\pm\\frac{d}{e}','radio-math'],
        ['as_13','\\frac{a}{bx^2}\\pm\\frac{c}{dx}','radio-math'],
        ['as_14','\\frac{a}{x+b}\\pm\\frac{x}{x-b}','radio-math'],
        ['as_15','\\frac{x+a}{x^2-b^2}\\pm\\frac{x+c}{x+b}','radio-math']
    ], 
...
export const ratex_mul_div_form = {
    ...
    radio_buttons: [
        ...
        ['md_1','\\frac{a}{x+b}\\cdot\\div\\frac{x+c}{d}','radio-math'],
        ['md_2','\\frac{a}{x+b}\\cdot\\div\\frac{c}{x+d}','radio-math'],
        ['md_3','\\frac{x+a}{b}\\cdot\\div\\frac{x+c}{x+d}','radio-math'],
        ['md_4','\\frac{x+a}{x+b}\\cdot\\div\\frac{x+c}{d}','radio-math'],
        ['md_5','\\frac{x+a}{x+b}\\cdot\\div\\frac{x+c}{x+d}','radio-math'],
        ['md_6','\\frac{ax}{b}\\cdot\\div\\frac{c}{dx}','radio-math'],
        ['md_7','\\frac{a}{bx}\\cdot\\div\\frac{c}{dx}','radio-math'],
        ['md_8','\\frac{a}{x^2+bx+c}\\cdot\\div\\frac{x+d}{x+e}','radio-math'],
        ['md_9','\\frac{x+a}{x^2+bx+c}\\cdot\\div\\frac{x+d}{e}','radio-math'],
        ['md_10','\\frac{x+a}{x^2+bx+c}\\cdot\\div\\frac{x+d}{x+e}','radio-math'],
        ['md_11','\\frac{x+a}{x^2+bx+c}\\cdot\\div\\frac{x^2+dx+e}{x+f}','radio-math'],
        ['md_12','\\frac{x+a}{x^2+bx+c}\\cdot\\div\\frac{x+d}{x^2+ex+f}','radio-math'],
        ['md_13','\\frac{x^2+ax+b}{x+c}\\cdot\\div\\frac{x^2+dx+e}{x^2+fx+g}','radio-math'],
        ['md_14','\\frac{x^2+ax+b}{x^2+cx+d}\\cdot\\div\\frac{x^2+ex+f}{x^2+gx+h}','radio-math'],
        ['md_15','\\frac{ax}{bx^2+cx}\\cdot\\div\\frac{x+d}{x+e}','radio-math'],
        ['md_16','\\frac{ax^2+bx}{cx^2+dx}\\cdot\\div\\frac{x+e}{x+f}','radio-math']
    ], 
